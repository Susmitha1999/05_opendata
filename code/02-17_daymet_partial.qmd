...
#install.packages("sf") -- simple feature: vector geospatial data
#install.packages("daymetr") -- provides API to get daily weather data 
#install.packages("remotes")  -- helps to install packages that are not in CRAN
#remotes::install_github("ropensci/USAboundaries") 
#remotes::install_github("ropensci/USAboundariesData") -- county and state boundaries data
